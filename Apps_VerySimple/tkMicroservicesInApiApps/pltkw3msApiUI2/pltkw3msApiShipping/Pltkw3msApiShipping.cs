...
{
    public partial class Pltkw3msApiShipping : ServiceClient<Pltkw3msApiShipping>, IPltkw3msApiShipping
    {
        ...
        public virtual IShipping Shipping
        {
        ...
        /// client pipeline.
        /// </param>
        public Pltkw3msApiShipping(params DelegatingHandler[] handlers)
            : base(handlers)
        {
            this._shipping = new Shipping(this);
            this._values = new Values(this);
        ...
        /// client pipeline.
        /// </param>
        public Pltkw3msApiShipping(Uri baseUri, params DelegatingHandler[] handlers)
            : this(handlers)
        {
            if (baseUri == null)
            {
        ...
        /// client pipeline.
        /// </param>
        public Pltkw3msApiShipping(ServiceClientCredentials credentials, params DelegatingHandler[] handlers)
            : this(handlers)
        {
            if (credentials == null)
            {
        ...
        /// client pipeline.
        /// </param>
        public Pltkw3msApiShipping(Uri baseUri, ServiceClientCredentials credentials, params DelegatingHandler[] handlers)
            : this(handlers)
        {
            if (baseUri == null)
            {
