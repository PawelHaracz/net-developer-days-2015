...
{
    internal partial class CustomerOperations : IServiceOperations<Pltkw3msCustomer>, ICustomerOperations
    {
        /// <summary>
        ...
        /// </param>
        internal CustomerOperations(Pltkw3msCustomer client)
        {
            this._client = client;
        }
        
        private Pltkw3msCustomer _client;
        
        /// <summary>
        /// Gets a reference to the Pltkw3msUI1.Pltkw3msCustomer.
        /// </summary>
        public Pltkw3msCustomer Client
        {
        ...
        /// Cancellation token.
        /// </param>
        public async Task<HttpOperationResponse<object>> PostByValueWithOperationResponseAsync(Customer value, CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // Validate
            if (value == null)
            {
