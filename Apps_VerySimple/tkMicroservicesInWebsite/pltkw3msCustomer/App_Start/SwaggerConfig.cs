    ...
    public class SwaggerConfig
    {
        public static void Register()
        {
            ...
            GlobalConfiguration.Configuration 
                .EnableSwagger(c =>
                    {
                        c.IncludeXmlComments(System.String.Format(@"{0}bin\pltkw3msCustomer.XML", System.AppDomain.CurrentDomain.BaseDirectory));
                        //Important for function like Get (collection) and Get(Id)
                        ...
                        //
                        c.SingleApiVersion("v1", "pltkw3msCustomer");
